...
This project is a demo project setup for candidates who are applying for frontend UI/UX developer role at [Quaero 3 India](https://quaero.com). Please clone this project and follow the steps mentioned in the test shared with you. 
